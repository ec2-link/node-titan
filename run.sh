...
id="AEE02DD7-BD44-4FBD-A779-FFD74A2448A3"  # ID yang dimasukkan secara langsung

container_count=1  # Jumlah node yang ingin dibuat

disk_size_gb=13  # Ukuran hard disk setiap node dalam GB
